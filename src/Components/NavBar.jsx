...
export default function NavBar() {
  ...
  return (
    <nav className="bg-[image:var(--gradient-primary)]">
      <div className="container flex items-center justify-between gap-10 relative z-100">
    ...
    ${
      isMenuOpen
        ...
        : "max-md:-translate-y-1 max-md:pointer-events-none max-md:opacity-0"
    }
  `}
        >
          <ul
            ref={navRef}
            className=" md:relative flex h-fit flex-1 items-center gap-1 p-1 max-md:flex-col "
          >
  ...
  `}
              ...
              >
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ...
                    } max-md:py-5 max-md:hover:bg-[#010a04]`
                  }
                >
                  {link.label}
                </NavLink>
            ...
            <span
              aria-hidden="true"
              className="pointer-events-none absolute bottom-0 h-0.5 rounded-full bg-background transition-all duration-300 ease-out max-md:hidden"
              style={{
                left: underline.left,
